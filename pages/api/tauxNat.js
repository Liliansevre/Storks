...
export default async (req, res) => {
    try {
        ...
        const collection = db.collection("TX NATALITE ANNUEL G")
        ...
        for (let element of result) {
            ...
            tauxNat.push(element['Taux de natalité - Gironde'])
        }
        // console.log(annee)
        // console.log(agemoyen);

        const augmentation = (((tauxNat.slice(-1)[0] - tauxNat.slice(-2)[0]) / tauxNat.slice(-2)[0]) * 100).toFixed(2)
