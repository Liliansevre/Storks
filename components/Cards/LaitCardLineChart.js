  ...
  useEffect(async () => {
    ...
    var config = {
      ...
      data: {
        ...
        datasets: [
          // {
          //   label: 'Tonnes de poudre infantiles conditionnées', 
          //   backgroundColor: "#fff",
          //   borderColor: "#fff",
          //   data: data['Tonnes de poudre infantiles conditionnées'],
          //   borderDash: [2,2],
          //   fill: false,
          // },
          {
        ...
        <div className="rounded-t mb-0 px-4 py-3 bg-transparent">
          <div className="flex flex-wrap items-center">
            <div className="relative w-full max-w-full flex-grow flex-1">
              ...
              <h2 className="text-white text-xl font-semibold">Production de lait</h2>
            </div>
          </div>
        </div>
        <div>
